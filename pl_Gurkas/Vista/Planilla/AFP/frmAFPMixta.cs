...
{
    public partial class frmAFPMixta : Form
    {
        public int _afp;
        ...
        private void frmAFPMixta_Load(object sender, EventArgs e)
        {
            ...
            if (leer.Read() == true)
            {
                txtcsf.Text = leer["CSF_AFP"].ToString();
                txtcass.Text = leer["CASS_AFP"].ToString();
        ...
        private void btnGuardar_Click(object sender, EventArgs e)
        {
            ...
            decimal cass = Convert.ToDecimal(txtcomisionanual.Text);
            decimal ps = Convert.ToDecimal(txtprimaseguro.Text);
            decimal aofp = Convert.ToDecimal(txtaporteobligarito.Text);
            ...
            try
            {
                actualizar.actualizarAFPMixta(_codcomisionafp, _afp, csf, cass, ps, aofp, mra, fecha, fecha_i);
